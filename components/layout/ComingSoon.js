  ...
  return (
    <div className="coming-soon">
      <div className="coming-soon-header-wrap">
        ...
        <p>
          We will fight as a community. While we flatten the curve, we will work
      ...
      <div className="coming-soon-footer-wrap">
        ...
        <br />
        <a href="mailto:neighbor.army@gmail.com" target="_blank">
          <button>Contact Email</button>
        </a>{" "}
        <br />
        <a href="https://github.com/Neighbor-Army/firebase" target="_blank">
